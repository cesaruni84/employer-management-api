insert into employer(id, first_Name, last_Name, salary) values(1, 'Willie', 'Bull', 15000);
insert into employer(id, first_Name, last_Name, salary) values(2, 'Phoebe', 'Whittaker', 25000);
